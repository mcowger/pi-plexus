...
A [pi](https://github.com/earendil-works/pi-mono) extension that adds [Plexus AI](https://plexus.ai) as a provider, dynamically discovering models from your Plexus instance.
